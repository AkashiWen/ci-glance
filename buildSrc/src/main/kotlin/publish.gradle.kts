        ...
        publications {
            create<MavenPublication>("release") {
                ...
                pom {
                    ...
                    url.set("https://github.com/akashiwen/ciglance/")
                    ...
                    scm {
                        connection.set("scm:git:git://github.com/akashiwen/ciglance.git")
                        developerConnection.set("scm:git:ssh://github.com/akashiwen/ciglance.git")
                        url.set("https://github.com/akashiwen/ciglance/")
                    }
                    issueManagement {
                        system.set("GitHub Issues")
                        url.set("https://github.com/akashiwen/ciglance/issues")
                    }
                }
            }
        }
